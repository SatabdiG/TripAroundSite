...
detector.on('smileNum', (smilesnum, face, image) => {
...
/*
//start detecting leftopeneyes for each image.
detector.on('lefteyeNum', (lefteyesnum, face, image) => {
  console.log(lefteyesnum);
	if (lefteyesnum > 0){
    console.log("found smile!")  
   lefteyeevar=1; 
}
    connect.addlefteye('mongodb://localhost:27017/testimages','storeimages',_mapdataversionid, _markerid,_imagename,_imagepath,_userid,_mapid,lefteyeevar,function(message){
      console.log("Message"+message);
      if(message == "yes")
        return res.end("yes");
      else
...
//start detecting rightopeneyes for each image.
detector.on('righteyeNum', (righteyesnum, face, image) => {
  console.log(righteyesnum);
	if (righteyesnum > 0){
    console.log("found smile!")  
   righteyeevar=1; 
}

    connect.addrighteye('mongodb://localhost:27017/testimages','storeimages',_mapdataversionid, _markerid,_imagename,_imagepath,_userid,_mapid,righteyeevar,function(message){
      console.log("Message"+message);
      if(message == "yes")
        return res.end("yes");
      else
...
//start detecting KISS for each image.
detector.on('kissNum', (kisssnum, face, image) => {
  console.log(kisssnum);
	if (kisssnum > 0){
    console.log("found smile!")  
   kissevar=1; 
}

    connect.addkiss('mongodb://localhost:27017/testimages','storeimages',_mapdataversionid, _markerid,_imagename,_imagepath,_userid,_mapid,kissevar,function(message){
      console.log("Message"+message);
      if(message == "yes")
        return res.end("yes");
      else
